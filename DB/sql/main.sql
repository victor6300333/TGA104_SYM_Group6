...
INSERT INTO productMain (productMainName) VALUES('居家');
...
values
('全館優惠85折', '2022-11-11', '2022-11-22', '0.85', '0', '0', '2022-11-08', '2022-11-10', '200', '', '優惠券每筆訂單只限一個賣場一次使用'),
...
CREATE TABLE member (
    ...
    userAccount varchar(200) not null comment '使用者帳號',
    userPassword varchar(200) not null comment '使用者密碼',
    userName varchar(200) not null comment '使用者姓名',
    phone varchar(200) comment '會員電話',
    mail varchar(200) not null comment '信箱',
    gender varchar(200)  comment '性別',
    birthday date comment '生日',
    userPhoto longblob comment '照片',
    registrationTime datetime not null comment '註冊時間',
    mailCertification boolean not null comment '信箱認證',
    idNumber varchar(200) comment '身分證字號',
    address varchar(200) comment '收件地址',
    sellerAuditApprovalState boolean not null comment '賣家審核狀態',
    currentShoppingCoin int not null comment '當前購物金總額customer',
...
INSERT INTO productSec (productMainID,productSecName) VALUES('1','電腦');
INSERT INTO productSec (productMainID,productSecName) VALUES('1','手機');
INSERT INTO productSec (productMainID,productSecName) VALUES('2','床');
INSERT INTO productSec (productMainID,productSecName) VALUES('2','桌椅');
...
CREATE TABLE creditCard (
    ...
    memberID int not null comment '會員ID',
    creditcardNumber varchar(200) not null comment '信用卡卡號',
    securityCode varchar(200) not null comment '信用卡安全碼',
	exDate Date not null comment '信用卡到期日',
...
announcementSerialID int not null  auto_increment comment "公告流水編號",
administratorID int not null comment '管理員編號',

announcementContent varchar(200) not null comment "公告內容",
...
offLoadStatus boolean not null comment "上架狀態 : 0 : ON / 1: OFF",
showStatus boolean  not null comment "0 : 首頁 / 1: 賣場",announcement
...
insert into announcement (administratorID, announcementContent, startDate, endDate, updateTime, offLoadStatus, showStatus)
values 
('1', '賣場公告', '2022-11-11', '2022-11-20', now(), 1, 1),
('2', '賣場公告', '2022-11-11', '2022-11-20', now(), 0, 1),
('3', '最新消息', '2022-11-11', '2022-11-20', now(), 0, 0),
('1', '最新消息', '2022-11-11', '2022-11-20', now(), 1, 0),
('1', '最新消息', '2022-11-11', '2022-11-20', now(), 0, 0);
...
create table product(
    ...
    productImg blob comment "商品圖片",
    productImg2 blob comment "商品圖片2",
    productImg3 blob comment "商品圖片3",
...
INSERT INTO product (storeID,productSecID,productName,productStock,source,insertTime,productStatus) 
VALUES('1','1','華碩桌上型電腦','200000','中國小黃人製造',now(),'1');
INSERT INTO product (storeID,productSecID,productName,productStock,source,insertTime,productStatus) 
VALUES('1','2','小米手機','600000','中國小黃人製造',now(),'1');
...
insert into couponUsageHistory(couponID, usageRecord, useDate)
values
('1', '0', '2022-11-12'),
('1', '0', '2022-11-13'),
('1', '1', '2022-11-14'),
...
INSERT INTO `order`(storeID,memberID,orderDate,orderStatus,receiver,phone,address,payType,originalTotal,useShoppingGold,useCouponGold,finalTotal)
 VALUES('1','4',now(),'0','議員','0911111111','中和','貨到付款','500','0','0','500');
INSERT INTO `order` (storeID,memberID,orderDate,orderStatus,receiver,phone,address,payType,originalTotal,useShoppingGold,useCouponGold,finalTotal)
 VALUES('1','5',now(),'0','彥峰','0911111111','台北','貨到付款','1000','0','0','1000');
...
INSERT INTO groupBuyOrder (groupBuyID,memberID,groupBuyProductID,groupBuyQuantity,
groupBuyTotal,orderTime,paymentTerm,paymentState,giftVoucher,
contactNumber,shippingLocation) 
VALUES(1,1,1,20,1000,now(),"信用卡",1,50,"0975119374","台北市");
INSERT INTO groupBuyOrder (groupBuyID,memberID,groupBuyProductID,groupBuyQuantity,
groupBuyTotal,orderTime,paymentTerm,paymentState,giftVoucher,
contactNumber,shippingLocation) 
VALUES(1,1,1,20,2000,now(),"信用卡",1,50,"0975119374","台中市");
INSERT INTO groupBuyOrder (groupBuyID,memberID,groupBuyProductID,groupBuyQuantity,
groupBuyTotal,orderTime,paymentTerm,paymentState,giftVoucher,
contactNumber,shippingLocation) 
VALUES(1,1,1,30,3000,now(),"信用卡",1,50,"0975119374","高雄市");
...
VALUES('1','1','10','50000','500000');
INSERT INTO orderDetail (orderID,productID,quantity,price,subTotal) 
VALUES('1','2','10','3000','30000');
...
values 
('1', '1', '雙11團購優惠開跑', '團購相關', '團購達5人享有9折優惠', '', '2022-11-11', '2022-11-20', now()),
('1', '2', '雙11團購優惠開跑', '活動相關','團購達10人享有85折優惠', '', '2022-11-11', '2022-11-20', now()),
('2', '1', '雙11團購優惠開跑', '團購相關', '團購達15人享有8折優惠', '', '2022-11-11', '2022-11-20', now()),
('1', '2', '雙11團購優惠開跑', '團購相關', '團購達20人享有75折優惠', '', '2022-11-11', '2022-11-20', now()),
('3', '1', '雙11團購優惠開跑', '團購相關', '團購達25人享有7折優惠', '', '2022-11-11', '2022-11-20', now());
