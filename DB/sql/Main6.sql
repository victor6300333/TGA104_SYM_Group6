...
showStatus boolean  not null comment "0 : 首頁 / 1: 賣場",
...
groupBuyProductOrderTotal int comment '團購商品訂購總數量',
groupBuyingState Boolean comment '團購狀態',
groupBuyingOnLoadDate date comment '團購上架日期', 
groupBuyingOffLoadDate date comment '團購下架日期',
updateTime timestamp comment '更新時間',
primary key(groupBuyID),
constraint Fk_groupBuying_administratorID
	foreign key (administratorID)
	references administrator(administratorID),
constraint Fk_groupBuying_groupBuyProductID
	foreign key (groupBuyProductID)
...
(2,1,1,20,2000,now(),"信用卡",1,50,"0975119374","台中市"),
(1,2,1,30,3000,now(),"信用卡",1,50,"0975119374","高雄市");
