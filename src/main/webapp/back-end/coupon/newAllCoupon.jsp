			...
			<nav class="navbar sym-skin navbar-light">
				...
				<div class="navbar-nav w-100">
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu bg-transparent border-0">
							<a 
								href="<%=request.getContextPath()%>/back-end/shoppingGoldRecord/listAllshoppingGoldRecord.jsp"
								class="dropdown-item">購物金管理</a> <a
								href="<%=request.getContextPath()%>/back-end/coupon/listAllCoupon.jsp"
								class="dropdown-item">優惠券管理</a> <a
								href="<%=request.getContextPath()%>/back-end/couponUsageHistory/listAllcouponUsageHistory.jsp"
									...
									<thead>
										...
										<c:forEach var="couponVO" items="${couponVO}">
											...
											<tr>
												...
												<td>
													<FORM METHOD="post"
														ACTION="<%=request.getContextPath()%>/back-end/coupon/newUpdateCoupon.jsp"
														style="margin-bottom: 0px;">
														<input type="submit" value="修改"> <input
															type="hidden" name="couponID"
															value="${couponVO.couponID}"> <input
