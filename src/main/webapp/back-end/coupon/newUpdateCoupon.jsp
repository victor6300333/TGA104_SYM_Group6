				...
				<div class="content-wrapper">
					...
					<div class="content-header">
						<div class="container-fluid">
							<div class="row mb-2">
								<div class="col-sm-6">
									<h2 class="m-0 sym-dark-font">優惠券設定 - 修改優惠券</h2>
								</div>
								<!-- /.col -->
						...
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<FORM METHOD="post"
										ACTION="<%=request.getContextPath()%>/front-end/coupon/getAll"
										name="form1">
										<table>
											<tr>
												<td>優惠券ID:</td>
												<td><input type="TEXT" name="couponID" size="45"
													value="${couponVO.couponID}" /></td>
											</tr>
											<tr>
												<td>優惠券姓名:</td>
												<td><input type="TEXT" name="couponName" size="45"
													value="${couponVO.couponName}" /></td>
											</tr>
											<tr>
												<td>有效期起:</td>
											...
											<tr>
												<td>優惠券描述:</td>
												<td><input type="TEXT" name="couponDescription"
													size="45" value="${couponVO.couponDescription}" /></td>
											</tr>

											<jsp:useBean id="couponSvc" scope="page"
												class="com.group6.tibame104.coupon.model.CouponService" />

										</table>
										<br> <input type="hidden" name="action" value="update">
										<input type="hidden" name="couponID"
											value="${couponVO.couponID}"> 
											<button
