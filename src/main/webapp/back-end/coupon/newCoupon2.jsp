				...
				<div class="content-wrapper">
					...
					<div class="content-header">
						<div class="container-fluid">
							<div class="row mb-2">
								<div class="col-sm-6">
									<h2 class="m-0 sym-dark-font">優惠券查詢</h2>
								</div>
								<!-- /.col -->
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<FORM METHOD="post"
										...
										name="form1">
										<button class="btn sym-darkpurple sym-yellow-font btn_style">顯示全部優惠券</button>
									</FORM>
									...
									<ul>
									<FORM METHOD="post"
										ACTION="<%=request.getContextPath()%>/back-end/coupon/newCoupon.jsp"
										name="form1">
										<button class="btn sym-darkpurple sym-yellow-font btn_style">新增優惠券</button>
									</FORM>
									</ul>
								</div>
							</div>
