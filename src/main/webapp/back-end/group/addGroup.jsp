				...
				<div class="content-wrapper">
					...
					<div class="content-header">
						<div class="container-fluid">
							<div class="row mb-2">
								<div class="col-sm-6">
									<h2 class="m-0 sym-dark-font">團購設定 - 新增團購</h2>
								</div>
								<!-- /.col -->
								...
								<div class="col-md-12">
									...
									<div class="card card-primary">
										<div class="card-header sym-darkpurple">
											<h3 class="card-title sym-yellow-font">團購設定 - 新增團購</h3>
										</div>
										<!-- /.card-header -->
										<!-- form start -->
										<form METHOD="post"
		ACTION="${pageContext.request.contextPath}/front-end/group/insert"
		name="form1">
											<div class="card-body">
													...
													<div class="display-flex mg-bottom-2">
														<div class="col-sm-4">
															<div class="form-group">
																<label class="sym-dark-font">
																	...
																	placeholder="開始日期" autocomplete="off" />
															</div>
														</div>
														<div class="col-sm-4 margin-left-1">
															<div class="form-group">
																<label class="sym-dark-font">
																	...
																	placeholder="結束日期" autocomplete="off" />
															</div>
														</div>
														<div class="col-sm-3 margin-left-1">
															<label class="sym-dark-font">
																...
																value="${(groupVO==null)? '1': groupVO.administratorID}"
																class="form-control" name="administratorID" id="administratorID" readonly />
														</div>
													</div>
												</div>
												<div class="row">
