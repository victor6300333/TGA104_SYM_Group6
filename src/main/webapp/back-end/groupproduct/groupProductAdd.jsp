...
<link
	href="${pageContext.request.contextPath}/back-end/groupproduct/lib/owlcarousel/assets/owl.carousel.min.css"
	rel="stylesheet" />
<link
	href="${pageContext.request.contextPath}/back-end/groupproduct/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css"
	rel="stylesheet" />

<!-- Customized Bootstrap Stylesheet -->
<link
	href="${pageContext.request.contextPath}/back-end/groupproduct/css/bootstrap.min.css"
	rel="stylesheet" />

<!-- Template Stylesheet -->
<link
	href="${pageContext.request.contextPath}/back-end/groupproduct/css/style.css"
	rel="stylesheet" />
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="card card-primary">
										...
										<!-- form start -->
										<FORM METHOD="post"
											ACTION="${pageContext.request.contextPath}/front-end/groupproduct/Groupproduct.do"
													...
													<div class="col-sm-4">
														<div class="form-group">
															<label for="proPrice" class="sym-dark-font">
																...
																value="<%=(groupproductVO == null) ? "0" : groupproductVO.getGroupBuyProductPrice()%>" />
														</div>
													</div>
													<div class="row">
														<div class="col-sm-6">
								...
								<div class="col-sm-12">
									<div class="form-floating">
										<textarea class="form-control" placeholder="請輸入商品描述"
											...
											value="<%=(groupproductVO == null) ? "請輸入商品描述" : groupproductVO.getGroupBuyProductDescrip()%>"
