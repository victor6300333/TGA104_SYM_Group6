      ...
      <nav class="navbar sym-skin navbar-light">
        ...
        <div class="d-flex align-items-center ms-4 mb-4">
          <div class="position-relative">
            <img class="rounded-circle" src="./img/logoSYM3.jpg" alt="" style="width: 40px; height: 40px" />
        ...
        <div class="navbar-nav w-100">
          <a href="index.html" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>管理員資料</a>
          ...
          <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-th me-2"></i>活動管理</a>
            <div class="dropdown-menu bg-transparent border-0">
              <a href="./advertise.html" class="dropdown-item">廣告設定</a>
    ...
    <div class="content sym-yellow-bk">
      ...
      <nav class="navbar navbar-expand sym-skin sticky-top px-4 py-0 mb-2rem">
        ...
        <div class="navbar-nav align-items-center ms-auto">
          ...
          <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
              <img class="rounded-circle me-lg-2" src="./img/logoSYM3.jpg" alt="" style="width: 40px; height: 40px" />
