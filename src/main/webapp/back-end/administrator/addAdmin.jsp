...
<title>新增管理員 - addAdmin.jsp</title>
...
<body>
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h2 class="m-0 sym-dark-font">新增管理員</h2>
				</div>
				<!-- /.col -->
	<div class="col-sm-6 flex-direction">
		<ol class="breadcrumb float-sm-right">
			<li class="breadcrumb-item"><a href="listAllAdmin.jsp">Home</a>
			</li>
	...
	<div class="card card-primary">
		<div class="card-header sym-darkpurple">
			<h3 class="card-title sym-yellow-font">管理員設定</h3>
		</div>
		<!-- /.card-header -->
	...
	<!-- form start -->
	<div class="card-body">
		<div class="form-group  mg-bottom-2">
...
<!-- 						<h5>管理員編號 : </h5> -->
	...
	<div class="row">
		<div class="col-sm-4">
			<div class="form-group">
				<label class="sym-dark-font"><h5>帳號 : </h5></label> <input
					type="text" class="form-control" name="adDescribe"
					id="proBrand" placeholder="請輸入帳號"
					value="" />
		</div>
	</div>
	...
	<div class="col-sm-4 mg-bottom-2">
		<div class="form-group">
			<label class="sym-dark-font"><h5>密碼 : </h5></label> <input
				type="text" name="groupBuyID" class="form-control"
				id="proBrand" placeholder="請輸入密碼"
				value="" />
				</div>
			</div>
...
<!-- 				<div class="col-sm-4"> -->
<!-- 					<div class="form-group"> -->
<!-- 						<label class="sym-dark-font"><h5>創建日期 : </h5></label> <input -->
