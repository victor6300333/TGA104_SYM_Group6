				...
				<div class="content-wrapper">
					...
					<div class="content-header">
						<div class="container-fluid">
							<div class="row mb-2">
								<div class="col-sm-6">
									<h2 class="m-0 sym-dark-font">優惠券紀錄設定 - 新增優惠券紀錄</h2>
								</div>
								<!-- /.col -->
								<div class="col-sm-6 flex-direction">
									<ol class="breadcrumb float-sm-right">
										<li class="breadcrumb-item"><a href="#">Home</a></li>
										<li class="breadcrumb-item active">優惠券紀錄設定</li>
									</ol>
								</div>
								<!-- /.col -->
							</div>
						...
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<FORM METHOD="post"
										ACTION="<%=request.getContextPath()%>/front-end/couponUsageHistory/insert"
										name="form1">
										<table>
											<tr>
												<td>會員ID:</td>
												<td><input type="TEXT" name="memberID" size="45"
													value="<%=(couponUsageHistoryVO == null) ? "" : couponUsageHistoryVO.getCouponID()%>" /></td>
											</tr>
											<tr>
												<td>優惠券ID:</td>
											...
											<tr>
												<td>使用紀錄:</td>
												<td><input type="TEXT" name="usageRecord" size="45"
													value="<%=(couponUsageHistoryVO == null) ? "" : couponUsageHistoryVO.getUsageRecord()%>" /></td>
											</tr>
											<tr>
												<td>使用日期:</td>
