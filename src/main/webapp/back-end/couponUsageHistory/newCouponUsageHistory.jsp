			...
			<nav class="navbar sym-skin navbar-light">
				...
				<div class="navbar-nav w-100">
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu bg-transparent border-0">
							<a
								href="<%=request.getContextPath()%>/back-end/shoppingGoldRecord/newShoppingGoldRecord.jsp"
								class="dropdown-item">購物金管理</a> <a
								href="<%=request.getContextPath()%>/back-end/coupon/newCoupon2.jsp"
								class="dropdown-item">優惠券管理</a> <a
								href="<%=request.getContextPath()%>/back-end/couponUsageHistory/newCouponUsageHistory.jsp"
				...
				<div class="content-wrapper">
					...
					<div class="content-header">
						<div class="container-fluid">
							<div class="row mb-2">
								<div class="col-sm-6">
									<h2 class="m-0 sym-dark-font">優惠券紀錄查詢</h2>
								</div>
								<!-- /.col -->
								<div class="col-sm-6 flex-direction">
									<ol class="breadcrumb float-sm-right">
										<li class="breadcrumb-item"><a href="#">Home</a></li>
										<li class="breadcrumb-item active">優惠券記錄設定</li>
									</ol>
								</div>
								<!-- /.col -->
							</div>
						...
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<ul>
										<FORM METHOD="post"
											ACTION="<%=request.getContextPath()%>/front-end/couponUsageHistory/getAll2"
											name="form1">
											<button class="btn sym-darkpurple sym-yellow-font btn_style">顯示全部優惠券紀錄</button>
										</FORM>


										<li>
											<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/front-end/couponUsageHistory/getOne_For_Display">
												<b>會員ID:</b> <input type="text" name="memberID"> <input
													type="hidden" name="action" value="getOne_For_Display">
												<button class="btn sym-darkpurple sym-yellow-font btn_style">搜尋優惠券紀錄</button>
											</FORM>
										</li>
									...
									<ul>
										<FORM METHOD="post"
											ACTION="<%=request.getContextPath()%>/back-end/couponUsageHistory/newAddCouponUsageHistory.jsp"
											name="form1">
											<button class="btn sym-darkpurple sym-yellow-font btn_style">新增優惠券紀錄</button>
										</FORM>
									</ul>
								</div>
							</div>
