				...
				<div class="content-wrapper">
					...
					<div class="content-header">
						<div class="container-fluid">
							<div class="row mb-2">
								<div class="col-sm-6">
									<h2 class="m-0 sym-dark-font">購物金查詢</h2>
								</div>
								<!-- /.col -->
						...
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<ul>
									<FORM METHOD="post"
										ACTION="<%=request.getContextPath()%>/front-end/shoppingGoldRecord/getAll"
										name="form1">
										<button class="btn sym-darkpurple sym-yellow-font btn_style">顯示全部購物金</button>
									</FORM>
									
						
										<li>
											<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/front-end/shoppingGoldRecord/getOne_For_Display">
												<b>會員ID:</b> <input type="text" name="memberID"> <input
													type="hidden" name="action" value="getOne_For_Display">
												<button class="btn sym-darkpurple sym-yellow-font btn_style">搜尋購物金紀錄</button>
											</FORM>
										</li>
									...
									<ul>
									<FORM METHOD="post"
										ACTION="<%=request.getContextPath()%>/back-end/shoppingGoldRecord/newAddShoppingGoldRecord.jsp"
										
										name="form1">
										<button class="btn sym-darkpurple sym-yellow-font btn_style">新增購物金</button>
									</FORM>
									</ul>
								</div>
							</div>
