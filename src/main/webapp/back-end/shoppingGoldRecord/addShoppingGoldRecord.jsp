...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="<%=request.getContextPath()%>/front-end/shoppingGoldRecord/select_page.jsp"><img src="images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/front-end/shoppingGoldRecord/ShoppingGoldRecord.do" name="form1">
<table>
	...
	<tr>
		<td>購物金異動金額:</td>
		<td><input type="TEXT" name="obtainShoppingCoin" size="45"
...
<% 
  ...
  try {
	    hiredate = shoppingGoldRecordVO.getUseDate();
   } catch (Exception e) {
