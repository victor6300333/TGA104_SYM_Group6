...
<body bgcolor='white'>
	...
	<FORM METHOD="post" ACTION="Groupdiscount.do" name="form1">
		<table>
			<tr>
				<td>折扣表編號:<font color=red><b>*</b></font></td>
				<td><%=groupdiscountVO.getCountTableID()%></td>
			</tr>
			<tr>
				<td>團購編號:</td>
				<td><input type="TEXT" name="groupBuyID" size="45"
					value="<%=groupdiscountVO.getGroupBuyID()%>" /></td>
			</tr>
			<tr>
				<td>團購總數:</td>
				<td><input type="TEXT" name="groupBuyProductOrderTotal" size="45"
					value="<%=groupdiscountVO.getGroupBuyProductOrderTotal()%>" /></td>
			</tr>

			<tr>
				<td>折扣數:</td>
				<td><input type="TEXT" name="groupBuyCount" size="45"
					value="<%=groupdiscountVO.getGroupBuyCount()%>" /></td>
			</tr>
			
		</table>
		<br> <input type="hidden" name="action" value="update"> 
		<input	type="hidden" name="countTableID" value="<%=groupdiscountVO.getCountTableID()%>"> 
