...
<table>
	<tr>
		<td>帳號:</td>
		<td><input type="TEXT" name="userAccount" size="45" 
			 value="<%= (memVO==null)? "a22222222" : memVO.getUserAccount()%>" /></td>
	</tr>
	<tr>
		<td>密碼:</td>
		<td><input type="TEXT" name="userPassword" size="45" 
			 value="<%= (memVO==null)? "cccccccccc" : memVO.getUserPassword()%>" /></td>
	</tr>
	<tr>
		<td>姓名:</td>
		<td><input type="TEXT" name="userName" size="45" 
			 value="<%= (memVO==null)? "林茶陶" : memVO.getUserName()%>" /></td>
	</tr>
	<tr>
		<td>手機:</td>
		<td><input type="TEXT" name="phone" size="45" 
			 value="<%= (memVO==null)? "0988888888" : memVO.getPhone()%>" /></td>
	</tr>
	<tr>
		<td>電子信箱:</td>
		<td><input type="TEXT" name="mail" size="45" 
			 value="<%= (memVO==null)? "a22222222@gmail.com" : memVO.getMail()%>" /></td>
	</tr>
	<tr>
		<td>性別:</td>
		<td><input type="TEXT" name="gender" size="45" 
			 value="<%= (memVO==null)? "M" : memVO.getGender()%>" /></td>
	</tr>
	<tr>
		<td>生日:</td>
	...
	<tr>
		...
		<td><input type="TEXT" name="idNumber" size="45" 
			 value="<%= (memVO==null)? "F123456789" : memVO.getIdNumber()%>" /></td>
	</tr>
	<tr>
		<td>地址:</td>
		<td><input type="TEXT" name="address" size="45"
			 value="<%= (memVO==null)? "地址" : memVO.getAddress()%>" /></td>
	</tr>
