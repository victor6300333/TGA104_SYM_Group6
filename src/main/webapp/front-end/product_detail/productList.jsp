        ...
        <div class="container-fluid">
          <nav class="navbar navbar-expand-md bg-dark navbar-dark">
            ...
            <div class="navbar-nav mr-auto">
              ...
              <a href="product-list.html" class="nav-item nav-link">我的賣場</a>
            ...
            <div class="container-fluid">
              <div class="row align-items-center">
                <div class="col-md-3">
                  <div class="logo">
                    <a href="index.html">
                      <img src="./img/logoSYM.jpg" alt="Logo" />
                    </a>
                  </div>
                </div>
                <div class="col-md-6">
                        ...
                        <div class="sidebar-widget widget-slider">
                            <div class="sidebar-slider normal-slider">
                                <div class="product-item">
                                    ...
                                    <div class="商品圖片">
                                        <a href="product-detail.html">
                                            <img src="img/product-10.jpg" alt="商品圖片">
                                        </a>
                                        <div class="product-action">
                                            <a href="#"><i class="fa fa-加入購物車"></i></a>
                                            <a href="#"><i class="fa fa-我的最愛"></i></a>
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="商品圖片">
                                        <a href="product-detail.html">
                                            <img src="img/product-9.jpg" alt="商品圖片">
                                        </a>
                                        <div class="product-action">
                                            <a href="#"><i class="fa fa-加入購物車"></i></a>
                                            <a href="#"><i class="fa fa-我的最愛"></i></a>
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="商品圖片">
                                        <a href="product-detail.html">
                                            <img src="img/product-8.jpg" alt="商品圖片">
                                        </a>
                                        <div class="product-action">
                                            <a href="#"><i class="fa fa-加入購物車"></i></a>
                                            <a href="#"><i class="fa fa-我的最愛"></i></a>
